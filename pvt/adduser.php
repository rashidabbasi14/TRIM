...
<body>
		...
		<div style='padding-left:20px;'>
			<?php
				echo "<div style='margin:0 auto;width: 100px;'><h3>Add User</h3></div><br><br>";
				...
				foreach( sqlsrv_field_metadata( $stmt ) as $fieldMetadata ) {
					...
					if($col!="uType" && $col!="userid")
					{
						if($col=="password")
							echo "$col <div style='position:absolute; display:inline; left:100;'><input type=password id='inp$col' value=''></div><br><br>";
						else if($col=="effectivedt")
							echo "$col <div style='position:absolute; display:inline; left:100;'><input type='date' id='inp$col' value=''></div><br><br>";
						else
